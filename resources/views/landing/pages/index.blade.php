...
<!-- START HOME -->
	<section id="home" class="home_bg"
		style="background-image: url(https://tracerstudy.smkn2pku.pocari.id/assets/artikel/Asia_Heritage.jpg);  background-size:cover; background-position: center center;">
		<div class="container">
			<div class="row">
				<div class="col-lg-10 offset-lg-1 col-sm-12 col-xs-12 text-center">
					<div class="hero-text">
						<h2>ASIA HERITAGE</h2>
						<p>Bangunan replika dari China, Jepang, dan Korea di desa warisan dengan seluncuran anak dan tempat berfoto.</p>
						<div class="home_btn">
