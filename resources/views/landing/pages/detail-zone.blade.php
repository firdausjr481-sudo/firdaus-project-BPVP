...
<!-- HERO / HEADER -->
<section class="section-top text-white" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset('storage/images/'.$zone->image) }}') center/cover no-repeat; padding: 100px 0;">
    <div class="container text-center">
        <h1 class="fw-bold">{{ $zone->name }}</h1>
        <p class="mt-2">{{ $zone->description }}</p>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm mb-4">
                    <h2 class="fw-bold">{{ $zone->name }}</h2>
                    <h5 class="text-success mb-3">
                        {{ $zone->price_range ?: 'Free Entry' }}
                    </h5>
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm mt-4">
                    ...
                    <form action="{{ route('landing.zone.review.store') }}" method="POST">
                        @csrf
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-white p-4 rounded-4 shadow-sm sticky-top" style="top: 20px;">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><strong>Zone:</strong> {{ $zone->description }}</li>
                        <li><strong>Hours:</strong> {{ $zone->opening_hours }}</li>
                        <li><strong>Price:</strong> {{ $zone->price ?: 'Free' }}</li>
                    </ul>
